from app.controllers.images_controller import download_image, download_zip_images, get_images, get_images_by_type, upload_image
...
bp.get('/<image_type>')(get_images_by_type)
